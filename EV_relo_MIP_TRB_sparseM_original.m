...
% use sparce matrix
% prog written by Tai-Yu Ma, Aug 13 2018
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% experiment setting
% casestudy 1 : 6 node case 
% casestudy 2 : large network: 
...
if casestudy==1%case study N=6
   ...
   Cj=3% max num of veh at a node
   rho=[ 0.2236 0.6416 1.1576]'%rho generated based on b=0;alfa=0.95;
   mu= 0.00006*N*ones(NN1,1);%service rate : 1 customer per 20 minutes
   load  Lamda100;
end
...
% visu flow 
if  casestudy==1 && exitflag==1 % 6 node case
    figure (1)
