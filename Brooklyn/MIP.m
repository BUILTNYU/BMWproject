...
function [RebalancePath,RebalanceDecision]=MIP(Lamda,layers,nodes, initial_loc,charg_stations,grid_dist,station_capacity)
   ...
   theta = 0.02; 
   mu = 200*N*ones(NN1,1); % service rate : 1 customer per 10 minutes
...
options = optimoptions(@intlinprog,'MaxNodes',10000,'CutGeneration','advanced');
