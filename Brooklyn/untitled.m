...
[RebalancePath]=IP(Lamda/20,5,6,[9, 3, 1, 1, 4, 1, 3, 3, 1, 3, 3, 13, 4, 26, 10, 13, 9, 18, 3, 1, 1, 1, 3, 1, 1, 3, 3, 3, 1, 3, 4, 1, 4, 29, 3],[2 6],5,[2 0]);

%---------------------------------------------- MIP PROGRAM ------------------------------------------------%

function [RebalancePath]=IP(Lamda,layers,nodes, initial_loc,charg_stations,grid_dist,station_capacity)
   ...
   theta = 0.2; 
   mu = 0.6*N*ones(NN1,1); % service rate : 1 customer per 10 minutes
